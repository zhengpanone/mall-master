<template>
  ...
  <div style="margin-top: 50px">
    ...
    <div class="table-container">
      <el-table ref="brandTable" :data="imgList" style="width: 100%" border>
    ...
    <el-dialog title="添加分类" :visible.sync="dialogVisiblenew" width="40%">
      <el-form
        :model="bannerInfo"
        ref="resourceCategoryForm"
        label-width="150px"
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="dialogVisiblenew = false" size="small"
          >取 消</el-button
        >
        <el-button type="primary" @click="finishCommit" size="small"
          >确 定</el-button
        >
      </span>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    handleDialogConfirm() {
      putBanner(this.bannerInfo.id, {
        index: this.bannerInfo.index,
    ...
    finishCommit(data) {
      ...
      createBanner(this.newbannerInfo)
        .then((res) => {
          this.$notify({
            title: "提示",
            message: "修改成功",
